<template>
  <div>
      ...
      <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px">
        ...
        <el-form-item label="父级分类:">
          ...
          <el-cascader  clearable v-model="selectedKeys" :options="parentCateList"
            :props="cascaderProps"   @change="parentCateChanged" class="gaodu">
          </el-cascader>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="编辑分类" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
      <el-form :model="editCateForm" :rules="editDialogVisibleRules" ref="editDialogVisibleRef" label-width="100px">
        <el-form-item label="分类名称:" prop="cat_name">
